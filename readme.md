...
Use `shift+U` to jump to the first line of interest of the current block's content, e.g. the first frame of a traceback.
And `U` to jump to the last line of interest of the block's content, e.g. last frame of a traceback.
